...
<a id="lawtext-vscode-extension"></a>
...
- When a law is under public comment, the only document made available is always a PDF, which is hard to modify or compare.
...
For the details of Lawtext, please visit the [Lawtext documentation](https://yamachig.github.io/Lawtext/).
...
[こちらのリンク (github.dev)](https://github.dev/yamachig/vscode-lawtext-sample) からすぐにお試しいただけます。（GitHubアカウントが必要です。リンク先でアカウントを作成できます。） / You can try the extension on [github.dev](https://github.dev/yamachig/vscode-lawtext-sample) with a few clicks. (A GitHub account is required. You can create one on the linked page.)
